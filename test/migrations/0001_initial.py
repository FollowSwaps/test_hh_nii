# Generated by Django 3.2.6 on 2021-08-02 19:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Budget',
            fields=[
                ('guid', models.CharField(max_length=36, verbose_name='Глобально-уникальный идентификатор записи')),
                ...
                ('parentcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='test.budget', verbose_name='Вышестоящий бюджет')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='test.budget', verbose_name='Бюджет')),
            ],
            options={
